...
async function downloadPDF() {
    ...
    const response = await fetch(`${API_URL}/pdf/reports/generate`, {
        method: "POST",
...
// Adicionando evento ao botão de exportação
const exportButton = document.getElementById("export-pdf");
if (exportButton) {
    exportButton.addEventListener("click", async () => {
        try {
            exportButton.disabled = true;
            document.getElementById("loading-pdf").style.display = "inline-flex";
